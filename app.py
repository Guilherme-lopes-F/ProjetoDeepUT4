...
def run_unet_segmentation(img: Image.Image, target_size=(256, 256)):
    ...
    # Visualizar o resultado antes de limiarizar
    st.image(pred, caption="Resultado da predição da U-Net", use_column_width=True)
...
def classify_mask(mask_img: Image.Image):
    ...
    # Vamos assumir que se houver mais de 100 pixels "ativos", é provável que haja tumor
